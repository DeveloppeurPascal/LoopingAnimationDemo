(* C2PP
  ...
  ***************************************************************************
  File last update : 2025-07-27T19:48:12.000+02:00
  Signature : 414678c0bb849fb17ad131d639c8867572852c69
  ***************************************************************************
*)

program FMXMeteorsExplosions;
...
uses
  ...
  FMXMeteorsMovesMainForm in '..\..\01-MeteorsMoves\FireMonkey\FMXMeteorsMovesMainForm.pas' {frmMeteorsMovesMainForm},
  FMXMeteorsExplosionsMainForm in 'FMXMeteorsExplosionsMainForm.pas' {frmMeteorsExplosionsMainForm};
...
begin
  ...
  Application.CreateForm(TfrmMeteorsExplosionsMainForm, frmMeteorsExplosionsMainForm);
  Application.Run;
end.
